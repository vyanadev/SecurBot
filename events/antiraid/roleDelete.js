...
module.exports = async (client, role) => {
    try {
        ...
        const r = await axios.get(`${base}/audit-logs?limit=1&action_type=${AuditLogEvent.RoleDelete}`, { headers: head });
        ...
        console.error("Erreur dans l'événement roleDelete:", error);
    }
};