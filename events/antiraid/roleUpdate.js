...
module.exports = async (client, oldRole, newRole) => {
    try {
        ...
        const r = await axios.get(`${base}/audit-logs?limit=1&action_type=${AuditLogEvent.RoleUpdate}`, { headers: head });
        ...
        console.error("Erreur dans l'événement roleUpdate:", error);
    }
};